...
const std::string WebContent::SCANNING_MODE_SELECTION = "SCANNING_MODE_SELECTION";
...
const std::string WebContent::MICROSTEP_M0_PIN = "MICROSTEP_M0_PIN";
const std::string WebContent::MICROSTEP_M1_PIN = "MICROSTEP_M1_PIN";
const std::string WebContent::MICROSTEP_M2_PIN = "MICROSTEP_M2_PIN";
const std::string WebContent::MOTOR_LIMIT_SWITCH_PIN = "MOTOR_LIMIT_SWITCH_PIN";
const std::string WebContent::MOTOR_LIMIT_SWITCH_VALUE = "MOTOR_LIMIT_SWITCH_VALUE";
const std::string WebContent::MICROSTEPPING_FACTOR = "MICROSTEPPING_FACTOR";
...
const std::string WebContent::MICROSTEP_M0_PIN_DESCR = "The wiringPi pin number for the M0 microstepping (-1 to disable)";
const std::string WebContent::MICROSTEP_M1_PIN_DESCR = "The wiringPi pin number for the M1 microstepping (-1 to disable)";
const std::string WebContent::MICROSTEP_M2_PIN_DESCR = "The wiringPi pin number for the M2 microstepping (-1 to disable)";
const std::string WebContent::MOTOR_LIMIT_SWITCH_PIN_DESCR = "The wiringPi pin number for the motor's limit switch";
const std::string WebContent::MOTOR_LIMIT_SWITCH_VALUE_DESCR = "0 if the limit switch is closed LOW, 1 if closed HIGH";
...
<div id=\"menuContainer\">\
  ...
  <div class=\"menu\"><a href=\"/settings\">SETTINGS</a></div>"
    ...
    sstr << setting(WebContent::MICROSTEP_M0_PIN, "Motor Microstepping M0 Pin", setup->motorMicrostepM0Pin, MICROSTEP_M0_PIN_DESCR);
    sstr << setting(WebContent::MICROSTEP_M1_PIN, "Motor Microstepping M1 Pin", setup->motorMicrostepM1Pin, MICROSTEP_M1_PIN_DESCR);
    sstr << setting(WebContent::MICROSTEP_M2_PIN, "Motor Microstepping M2 Pin", setup->motorMicrostepM2Pin, MICROSTEP_M2_PIN_DESCR);
    
    std::string microRatio1 = setup->motorMicrostepFactor == 0 ? " SELECTED" : "";
    std::string microRatio2 = setup->motorMicrostepFactor == 1 ? " SELECTED" : "";
    std::string microRatio4 = setup->motorMicrostepFactor == 2 ? " SELECTED" : "";
    std::string microRatio8 = setup->motorMicrostepFactor == 3 ? " SELECTED" : "";
    std::string microRatio16 = setup->motorMicrostepFactor == 4 ? " SELECTED" : "";
    std::string microRatio32 = setup->motorMicrostepFactor == 5 ? " SELECTED" : "";
    
    sstr << "<div><div class=\"settingsText\">Microstepping ratio</div>";
    sstr << "<select name=\"" << WebContent::MICROSTEPPING_FACTOR << "\">";
    sstr << "<option value=\"0\"" << microRatio1 << ">Full Stepping</option>\r\n";
    sstr << "<option value=\"1\"" << microRatio2 << ">1/2 Stepping</option>\r\n";
    sstr << "<option value=\"2\"" << microRatio4 << ">1/4 Stepping</option>\r\n";
    sstr << "<option value=\"3\"" << microRatio8 << ">1/8 Stepping</option>\r\n";
    sstr << "<option value=\"4\"" << microRatio16 << ">1/16 Stepping</option>\r\n";
    sstr << "<option value=\"5\"" << microRatio32 << ">1/32 Stepping</option>\r\n";
    sstr << "</select></div>";
    sstr << "<div class=\"settingsDescr\">The microstepping ratio of the motor.</div>\n";
    
    sstr << setting(WebContent::MOTOR_LIMIT_SWITCH_PIN, "Motor Limit Switch Pin", setup->limitSwitchPin, MOTOR_LIMIT_SWITCH_PIN_DESCR);
    sstr << setting(WebContent::MOTOR_LIMIT_SWITCH_VALUE, "Motor Limit Switch Value", setup->limitSwitchValue, MOTOR_LIMIT_SWITCH_VALUE_DESCR);
...
<div style=\"padding-left: 0px\"><input name=\"cmd\" class=\"submit\" value=\"Delete\" type=\"submit\"></div>";
    ...
    // Scanning Mode UI
    //
    ScanningMode scanMode = preset.scanMode;
    std::string turnTableSel  = scanMode == TURN_TABLE  ? " SELECTED" : "";
    std::string sipSel = scanMode == SCAN_IN_PLACE ? " SELECTED" : "";
    
    sstr << "<div><div class=\"settingsText\">Scanning Mode</div>";
    sstr << "<select name=\"" << WebContent::SCANNING_MODE_SELECTION << "\">";
    sstr << "<option value=\"0\"" << turnTableSel << ">Turn Table</option>\r\n";
    sstr << "<option value=\"1\"" << sipSel << ">Scan in Place</option>\r\n";
    sstr << "</select></div>";
    sstr << "<div class=\"settingsDescr\">The operating mode of the scanner.</div>\n";
    ...
    std::string video8Sel   = cameraMode == Camera::CM_VIDEO_8MP ? " SELECTED" : "";
    ...
    sstr << "<option value=\"" << (int)Camera::CM_STILL_8MP << "\"" << still8Sel << ">8 Megapixel (still mode, 3280x2464)</option>\r\n";
    sstr << "<option value=\"" << (int)Camera::CM_VIDEO_8MP << "\"" << video8Sel << ">8 Megapixel (video mode, 3280x2464)</option>\r\n";
