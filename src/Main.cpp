...
struct InitSingletons
{
	InitSingletons()
	{
        freelss::Preset currPreset = freelss::PresetManager::get() -> getActivePreset ();
        std::cout << "Init Singletons: scanMode = " << currPreset.scanMode <<"\n";
        freelss::A4988MotorDriver::initialize();
